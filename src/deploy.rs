...
async fn main() -> Result<()> {
    ...
    // Creating a transaction which will include code for deploying the contract
    ...
    // Contract don't need any constructor arguments, so we can use an empty tuple
